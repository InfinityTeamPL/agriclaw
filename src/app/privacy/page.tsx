    ...
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto prose prose-gray">
        ...
        <section className="space-y-6 text-muted-foreground leading-relaxed">
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">1. Administrator danych</h2>
            <p>
              Administratorem Twoich danych osobowych jest AgriClaw (dalej „My", „Serwis").
              Kontakt w sprawach prywatności: <a className="text-primary hover:underline" href="mailto:contact@infinityteam.io">contact@infinityteam.io</a>.
            </p>
          </div>

          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">2. Jakie dane przetwarzamy</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">3. Cel i podstawa prawna</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">4. Twoje prawa</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">5. Przechowywanie danych</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">6. Pliki cookies</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">7. Bezpieczeństwo</h2>
            <p>
