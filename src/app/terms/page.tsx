  ...
  return (
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto prose prose-gray">
        ...
        <h1 className="font-display text-4xl font-semibold tracking-tight text-foreground mt-6 mb-2">
          Regulamin serwisu
        </h1>
        <p className="hud-label mb-8">Ostatnia aktualizacja: 18 kwietnia 2026</p>

        <section className="space-y-6 text-muted-foreground leading-relaxed">
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">1. O czym to jest</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">2. Kto może korzystać</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">3. Rejestracja i konto</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">4. Jak działa rada</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">5. Plan darmowy i płatny</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">6. Co należy do Ciebie, a co do nas</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">7. Dostępność</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">8. Zakończenie korzystania</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">9. Zmiany regulaminu</h2>
            <p>
          ...
          <div>
            <h2 className="font-display text-xl font-semibold tracking-tight text-foreground mb-2">10. Kontakt</h2>
            <p>
              W każdej sprawie napisz na <a className="text-primary hover:underline" href="mailto:contact@infinityteam.io">contact@infinityteam.io</a>.
