...
**Nabór:** **14.05–28.08.2026, 16:00** ✅ *potwierdzone 3-0 na gov.pl/ncbr (stan 09.06.2026: „Trwa nabór") — sekcja 9*
...
## 9. Status weryfikacji (deep-research, 2026-07-05)

Zweryfikowane głosowaniem adwersaryjnym 3-0 na źródle pierwotnym (https://www.gov.pl/web/ncbr/agrostrateg-ikonkurs):

- ✅ **Nabór TRWA: 14.05.2026 – 28.08.2026, 16:00** (stan strony 09.06.2026: „Trwa nabór wniosków"). Zostaje ~6 tygodni.
- ✅ **Obszar T3 „Rolnictwo cyfrowe"** — cytat: „wykorzystanie technologii i analizy danych do optymalizacji produkcji roślinnej i zwierzęcej". Bezpośrednie dopasowanie do AgriClaw.
- ✅ **Budżet konkursu 300 mln zł; dofinansowanie projektu 1–25 mln zł** (nasze 9,4 mln mieści się w widełkach, poniżej maksimum → wyższe szanse).
- ✅ **Konsorcjum NIE jest obowiązkowe.** Dopuszczalne: (a) konsorcjum max 5 podmiotów, ≥1 przedsiębiorstwo + ≥1 organizacja badawcza, (b) konsorcjum przedsiębiorstw (max 5), albo (c) **pojedyncze przedsiębiorstwo samodzielnie**. Lider = przedsiębiorstwo albo organizacja badawcza. → Nasz układ konsorcjum jest opcją mocniejszą, ale nie warunkiem formalnym.

Nadal DO POTWIERDZENIA (weryfikacja przerwana limitem sesji — źródła zebrane, brak głosowania; dokończyć w regulaminie naboru):

- [ ] dokładny wymóg % kosztów po stronie przedsiębiorstw (nasze założenie 40% — sprawdzić w regulaminie) i czy ODR kwalifikuje się jako konsorcjant
- [ ] tabela intensywności pomocy publicznej i katalog kosztów kwalifikowanych
- [ ] czy zdefiniowany jest wymagany TRL wejściowy/wyjściowy
